...
// A buffer of randomness (computed with stream256_squeezeblocks) will be used.
...
void polyvecl_uniform_polytope(polyvecl *v,
...
{  
  ...
  do {
    ...
    // at the end of this boucle for, coeffs[0], ..., coeffs[L*N+1] will be such that:
    // coeffs[0] = 0
